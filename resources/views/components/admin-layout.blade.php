...
{{--                                    </span>--}}
                                <div class="dropdown-item ai-icon d-inline-flex">
        ...
        <div class="dlabnav-scroll">
            <ul class="metismenu" id="menu">
                ...
                <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <span class="nav-text">Cause List</span>
                    </a>
                    <ul aria-expanded="false">
                        <li><a href="{{ url('admin/cause-lists') }}">Upload Cause List</a></li>
                        <li><a href="">All Cause Lists</a></li>
                    </ul>
