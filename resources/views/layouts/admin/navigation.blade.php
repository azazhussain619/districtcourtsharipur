...
{{--        <img src="{{ asset('admin/dist/img/AdminLTELogo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">--}}
        <span class="brand-text font-weight-light">District Courts Haripur</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="{{ asset('storage/images/'.auth()->user()->profile->image) }}" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
...
{{--                            <span class="badge badge-info right">6</span>--}}
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ url('admin/designations/create') }}" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
